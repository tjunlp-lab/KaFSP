...
from EDdata import DataPrecessForSentence
from EDutils import train, validate
from transformers import XLNetTokenizer
from EDmodel import XlnetModel
...
def main(train_file, dev_file, target_dir, 
         ...
         patience=3,
         max_grad_norm=10.0,
         checkpoint='model/best.pth.tar'):
    bert_tokenizer = XLNetTokenizer.from_pretrained('xlnet-base-cased', do_lower_case=True)
...
if __name__ == "__main__":
    main("train.csv", "valid.csv", "model")